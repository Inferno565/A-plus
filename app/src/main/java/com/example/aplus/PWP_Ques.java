...
public class PWP_Ques extends AppCompatActivity {
    public static final String TABLE_6 = "pwp";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pwp_ques);
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String str = "CREATE TABLE IF NOT EXISTS " + TABLE_6 + "(ID INTEGER PRIMARY KEY AUTOINCREMENT,Question TEXT,Option1 TEXT,Option2 TEXT,Option3 TEXT,Correctans TEXT)";
    ...
    public void insertData(String t2sciq, String t2scio1, String t2scio2, String t2scio3, String t2scicop) {
        ...
        values6.put("Question", t2sciq);
        values6.put("Option1", t2scio1);
        values6.put("Option2", t2scio2);
        values6.put("Option3", t2scio3);
        values6.put("Correctans", t2scicop);
