...
public class MAD_quiz extends AppCompatActivity {
...
int score;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mad_quiz);
        ...
        Cursor abc = sqLiteDatabase.rawQuery("Select Question,Option1,Option2,Option3 from mad", null);
