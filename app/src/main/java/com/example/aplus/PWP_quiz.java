...
public class PWP_quiz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pwp_quiz);
        ...
        Cursor abc = sqLiteDatabase.rawQuery("Select Question,Option1,Option2,Option3 from pwp", null);
