...
public class php_ques extends AppCompatActivity {
    public static final String TABLE_4 = "php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_php_ques);
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String str = "CREATE TABLE IF NOT EXISTS " + TABLE_4 + "(ID INTEGER PRIMARY KEY AUTOINCREMENT,Question TEXT,Option1 TEXT,Option2 TEXT,Option3 TEXT,Correctans TEXT)";
